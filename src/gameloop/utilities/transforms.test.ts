...
function getOrientationVectors(rollDegrees:number, pitchDegrees:number) {
    ...
    return [
        positionedObject.noseOrientation,
        positionedObject.roofOrientation,
        positionedObject.rightOrientation
    ]
}
...
describe('calculateRotation tests', () => {
    test('Axis aligned', () => {
        const [nr, rr, sr] =
            calculateRotation([0,0,-1], [0,1,0], [1,0,0])
