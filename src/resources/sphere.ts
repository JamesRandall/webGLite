...
class BufferArray {
    ...
    get numberOfElements(){ return this.items.length / this.numberOfComponents}
...
export function createSphere(gl: WebGLRenderingContext,
    options: {
    radius:number,
    subdivisionsAxis:number,
    subdivisionsHeight:number,
    ...
    const geometry = createSphereVertices(
        options.radius,
